...
--
-- Host: localhost
-- Generation Time: May 29, 2018 at 12:59 PM
...
--
-- Table structure for table `catAttributes`
--

CREATE TABLE IF NOT EXISTS `catAttributes` (
  `Name` varchar(128) NOT NULL,
  `HairColor` varchar(128) NOT NULL,
  `Coloreyes` varchar(128) NOT NULL,
...
(55379, 'Nandos Feet', 'Shakopee'),
(55379, 'Nandos Feet', 'Shakopee'),
(9128, 'Louie & Harrys', 'bradford');
